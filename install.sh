...
# Проверка существования папки с майнером
if [ ! -d "heminetwork_v1.0.0_linux_amd64" ]; then
    ...
    echo "Майнер уже установлен в папке heminetwork_v1.0.0_linux_amd64"
    cd heminetwork_v1.0.0_linux_amd64
fi
...
echo ""
echo "Текущий газ (fastestFee): ${gas_price} сатоши за байт"
